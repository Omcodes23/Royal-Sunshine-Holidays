...
const Footer = () => {
  ...
  return (
      ...
      <div className="container-custom relative z-10">
                          {/* Main Footer Content */}
         <div className="py-12 lg:py-16 px-4 sm:px-6 lg:px-0">
                 ...
                 <div className="text-left">
                   <div className="flex justify-center">
                                          <PinContainer
                        title="View on Maps"
                        href="https://maps.app.goo.gl/BrSP7UuYQr2VrTEP7"
                      >
...
Gotri, Vadodara, Gujarat 390023
                            ...
                            <iframe 
                              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59049.290236171175!2d73.09237105121478!3d22.331694389248625!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395fc98b02e2b13f%3A0x2f6cc22aa9f498c5!2sPrince%20Cube!5e0!3m2!1sen!2sin!4v1760807559647!5m2!1sen!2sin"                     width="100%" 
                              height="100%" 
                              style={{border:0}} 
                              allowFullScreen="" 
                              loading="lazy" 
       ...
       <div className="bg-gray-100 border-t border-gray-200">
         <div className="container-custom py-3 lg:py-4 px-4 sm:px-6 lg:px-0">
